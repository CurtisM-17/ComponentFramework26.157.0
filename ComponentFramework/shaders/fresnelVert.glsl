...
layout(location = 0) out vec3 vertexDir;
...
void main() {
    ...
    vertexDir = vertexPosCameraSpace - cameraPosCameraSpace; // Umer really doesnt need to subtract by (0, 0 ,0)
    ...
    normalCameraSpace = mat3(inverse(transpose(viewMatrix * modelMatrix))) * inNormal;
